...
export default function TenantsPage() {
  ...
  const [assignOwnerTenantId, setAssignOwnerTenantId] = useState<string | null>(
    null
  );
  const [assignMembershipTenantId, setAssignMembershipTenantId] = useState<
    string | null
  >(null);
                                ...
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <Button
                                      ...
                                      size="sm"
                                      onClick={() =>
                                        handleAssignMembership(tenant.id)
                                      }
                                      className="h-8 w-8 p-0"
                                    >
